...
//     environment {
//         DOCKER_USERNAME = credentials('docker-username')  // Use credentials for Docker username
//         DOCKER_PASSWORD = credentials('docker-password')  // Use credentials for Docker password
//     }
