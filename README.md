...
- Enter in your browser: 127.0.0.1:3000
    - username: admin
    - password: kubectl get secret --namespace monitoring my-grafana -o jsonpath="{.data.admin-password}" | base64 --decode ; echo
# configuration
- download values.yaml file and add in repo
  https://github.com/grafana/helm-charts/blob/main/charts/grafana/values.yaml
- update pvc and set it to true
  - helm upgrade my-grafana grafana/grafana -f monitoring/values.yaml -n monitoring
...
# debugging
- go to grafana.ini and set log mode to debug if needed
  - helm upgrade my-grafana grafana/grafana -f monitoring/values.yaml -n monitoring
